    ...
    <div class="tile is-vertical">
      <div class="tile">
        <div class="tile is-8 is-parent">
          <NuxtLink class="tile is-child box projects-bg" to="/projektu-rengimas-es-paramai-gauti">
        ...
        <div class="tile is-parent">
          <NuxtLink class="tile is-child box wheat-bg" to="/projektu-rengimas-zemes-ukiui">
      ...
      <div class="tile">
        <div class="tile is-8 is-parent">
          <NuxtLink class="tile is-child box plan-bg" to="/verslo-plano-rengimas">
        ...
        <div class="tile is-parent">
          <NuxtLink class="tile is-child box startup-bg" to="/verslo-planas-kredito-unijai">
      ...
      <div class="tile">
        <div class="tile is-8 is-vertical">
          <div class="tile">
            <div class="tile is-parent">
              <NuxtLink class="tile is-child box team-bg" to="/apie">
            ...
            <div class="tile is-parent">
              <NuxtLink class="tile is-child box contacts-bg" to="/kontaktai">
          ...
          <div class="tile is-parent">
            <NuxtLink class="tile is-child box finance-bg" to="/finansavimo-galimybes-lietuvoje">
        ...
        <div class="tile is-parent">
          <NuxtLink class="tile is-child box faq-bg" to="/duk">
